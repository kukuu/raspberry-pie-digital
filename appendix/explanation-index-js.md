...
| `const { WorkerSystem } = require('./lib/workers');` | **Custom Class Import** | Imports the `WorkerSystem` class from a local file. This class  represents a single worker or station in the simulated manufacturing process. |
